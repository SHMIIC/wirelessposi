...
#ifdef USE_USART1
COMx_Define	COM1;
u8	USART_BUF_type TX1_Buffer[COM_TX1_Lenth];	//发送缓冲
u8 	USART_BUF_type RX1_Buffer[COM_RX1_Lenth];	//接收缓冲
#endif

#ifdef USE_USART2
COMx_Define	COM2;
u8	USART_BUF_type TX2_Buffer[COM_TX2_Lenth];	//发送缓冲
u8 	USART_BUF_type RX2_Buffer[COM_RX2_Lenth];	//接收缓冲
#endif
